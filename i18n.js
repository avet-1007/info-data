...
const STRINGS = {
  en: {
    ...
    'app.console': 'Console', 'app.help': 'Supported formats', 'app.settings': 'Settings',
  ...
  ru: {
    ...
    'cmd.help': 'список команд', 'cmd.pwd': 'текущая папка', 'cmd.ls': 'список', 'cmd.cd': 'перейти в папку', 'cmd.project': 'создать проект (папку в корне)', 'cmd.mkdir': 'создать папку', 'cmd.touch': 'создать файл', 'cmd.write': 'записать в файл', 'cmd.cat': 'показать файл', 'cmd.open': 'открыть в редакторе', 'cmd.rm': 'удалить', 'cmd.mv': 'переместить / переименовать', 'cmd.cp': 'копировать', 'cmd.tree': 'дерево', 'cmd.find': 'поиск по имени', 'cmd.echo': 'вывести текст', 'cmd.clear': 'очистить консоль',
  },
  hy: {
    'app.connect': 'Միացնել թղթապանակ', 'app.reconnect': 'Բացել «{name}»',
    'app.project': 'Նախագիծ', 'app.folder': 'Թղթապանակ', 'app.document': 'Փաստաթուղթ',
    'app.console': 'Կոնսոլ', 'app.help': 'Աջակցվող ձևաչափեր', 'app.settings': 'Կարգավորումներ',
    ...
    'cmd.help': 'հրամանների ցանկ', 'cmd.pwd': 'ընթացիկ թղթապանակ', 'cmd.ls': 'ցանկ', 'cmd.cd': 'անցնել թղթապանակ', 'cmd.project': 'նոր նախագիծ (արմատային թղթապանակ)', 'cmd.mkdir': 'ստեղծել թղթապանակ', 'cmd.touch': 'ստեղծել ֆայլ', 'cmd.write': 'գրել ֆայլում', 'cmd.cat': 'ցույց տալ ֆայլը', 'cmd.open': 'բացել խմբագրում', 'cmd.rm': 'ջնջել', 'cmd.mv': 'տեղափոխել / վերանվանել', 'cmd.cp': 'պատճենել', 'cmd.tree': 'ծառ', 'cmd.find': 'որոնում ըստ անվան', 'cmd.echo': 'տպել տեքստ', 'cmd.clear': 'մաքրել կոնսոլը',
  },
};
